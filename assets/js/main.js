...
var display = function (element, type) {
  if (element) {
...
// Loader
setTimeout(() => {
  display(document.getElementsByClassName("loading-screen")[0], "none");

  display(document.getElementById("about"), "block");
  display(document.getElementById("skills"), "block");
